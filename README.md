...
このコマンドは `ENDPRM`コマンドで終了するまで指定したレートで送信される．</br>

```bash
# 0x02 0x40 <メジャーバージョン> <マイナーバージョン> <パッチバージョン> <ベース電圧> <センサ0状態> <センサ1状態> <センサ2状態> <センサ3状態> <ME0> <ME1> <ME2> <ME3> <SME0> <SME1> <SME2> <SME3> 0x03
[STX] 0x40 [MJV] [MIV] [PTV] [VB] [CON0] [CON1] [CON2] [CON3] [ME0] [ME1] [ME2] [ME3] [SME0] [SME1] [SME2] [SME3] [ETX]
```
