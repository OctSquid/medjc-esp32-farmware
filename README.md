...
| パラメータ | サイズ  |                                 説明                                  |
| :--------: | :-----: | :-------------------------------------------------------------------: |
|    `VB`    | `2byte` | ベース電圧.16bit 符号なし整数.`0-5`V を`0-65535`の範囲に置き換えた値. |
...
# EX)  0x02 0x30 0x0506 0xF8E2 0x0000 0x0000 0x03 -> ME0: 1286, ME1: -10014, ME2: 0, ME3: 0
[STX] 0x30 [ME0] [ME1] [ME2] [ME3] [ETX]
```

|     パラメータ     | サイズ  |                            説明                            |
| :----------------: | :-----: | :--------------------------------------------------------: |
| `ME{n}`(`n`:`0-3`) | `2byte` | ME 値. 符号あり 16bit 整数.センサが接続されていない場合`0` |
...
# EX)  0x02 0x31 0x001F 0x02FC 0x0000 0x0000 0x03 -> SME0: 31, SME1: 764, SME2: 0, SME3: 0
[STX] 0x31 [SME0] [SME1] [SME2] [SME3] [ETX]
```

|     パラメータ      | サイズ  |                            説明                             |
| :-----------------: | :-----: | :---------------------------------------------------------: |
| `SME{n}`(`n`:`0-3`) | `2byte` | SME 値. 符号なし 16bit 整数.センサが接続されていない場合`0` |
